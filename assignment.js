// ******* start Problem 01: Convert Feet to mile  *******

function feetToMile(distance) {
    var oneFeet = 0.000189394; // 1 feet = 0.000189394 mile.
    if (distance < 0) {
        return -1;
    } else {
        var mile = distance * oneFeet; // convert feet to mile
    }
    return mile;
}
...
// user input:
var feet = 30000;
var mile = feetToMile(feet).toFixed(6); // call function for convert

if (feet >= 0) {
    console.log(feet + " Feet = " + mile + " Mile. \n");//output
} else {
    console.log("Distance can't be negetive.\n");
}
// ******* end Problem 01: Convert Feet to mile  *******




// ******* start Problem 02: Wood Calculator *******
...
// ******* end Problem 02: Wood Calculator *******




// ******* start Problem 03: Brick Calculator ******* 
...
function brickCalculator(floor) {
    ...
    if (floor <= 0) {
        ...
        firstTenFloor = floor - afterTenFloor; // find first 10 floor.
        brickOfFirst10th = firstTenFloor * maximumHeight * brickPerFeet; // brick for first 10th floor
...
// ******* end Problem 03: Brick Calculator ******* 





// ******* start Problem 04: Find Tiny Friend ******* 

function tinyFriend(friend) {
    var len = friend.length; //length of array index
    if (len == 0) { // check array is empty or not
        ...
        for (var i = 0; i < len; i++) {
            if (friend[i].length < tinyName.length) { // find name of minimum length
                tinyName = friend[i]; // replace with pre-set value.
            }
        }
    }
    return tinyName;
...
// user input:
var name = ["Xubayer", "ChoCho", "Azhar Hasan", "Fardin Ahmes", "Abrar Sujon", "Roton Khan" , "Naeeeem" ,"Noor Alom"];
...
// ******* end Problem 04: Find Tiny Friend ******* 




// *************  thnaks for read this code  *************